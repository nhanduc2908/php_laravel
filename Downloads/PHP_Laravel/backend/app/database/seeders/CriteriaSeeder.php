...
class CriteriaSeeder extends Seeder
{
    ...
    {
        $domains = [
            1 => 'GOV', 2 => 'RISK', 3 => 'ASSET', 4 => 'ACCESS', 5 => 'CRYPTO',
            6 => 'PHYSICAL', 7 => 'OPERATIONS', 8 => 'COMMS', 9 => 'DEVOPS',
            10 => 'SUPPLY', 11 => 'INCIDENT', 12 => 'BCP', 13 => 'COMPLIANCE',
            14 => 'SECURITY_CONFIG', 15 => 'MONITOR', 16 => 'THREAT', 17 => 'CLOUD'
        ];
        ...
        foreach ($domains as $categoryId => $prefix) {
            $limit = $index < 8 ? 17 : 16; // 8 domains đầu 17 tiêu chí, còn lại 16
