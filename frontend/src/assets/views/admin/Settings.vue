<template>
    <div class="settings"><h2>Cài đặt hệ thống</h2><form @submit.prevent="saveSettings"><div class="form-group"><label>Tên hệ thống</label><input v-model="settings.app_name" type="text"></div>
    ...
    <button type="submit" class="btn-primary">Lưu</button></form></div>
</template>

<script setup>
import { ref, onMounted } from 'vue'
import { useSettingStore } from '@/stores/setting'
const settingStore = useSettingStore(); const settings = ref({})
