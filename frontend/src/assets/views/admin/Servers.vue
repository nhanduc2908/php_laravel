<template>
    ...
    <div class="card-actions"><button @click="testConnection(server.id)"><i class="fas fa-plug"></i></button><button @click="scanServer(server.id)"><i class="fas fa-search"></i></button><button @click="editServer(server)"><i class="fas fa-edit"></i></button><button @click="deleteServer(server.id)"><i class="fas fa-trash"></i></button></div></div></div></div>
</template>
